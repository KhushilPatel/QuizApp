...
export default function Register() {
  ...
  return (
    <div className="min-h-screen flex bg-[#0D1321] ">
      ...
      <div className='flex'>
        <div className="w-1/2 bg-[#0D1321] p-4 flex flex-col justify-center ml-20 mt-12">
          ...
          <form onSubmit={handleSubmit}>
            ...
            <div className="flex mb-4">
              <div className="w-1/2 mr-2">
                <label className="block text-[#FFFFFF]">Date of Birth</label>
                <input
                  type="date"
                  name="dateOfBirth"
              ...
              <div className="w-1/2 ml-2">
                <label className="block text-[#FFFFFF]">Gender</label>
                <select
                  name="gender"
                  value={formData.gender}
                  onChange={handleChange}
                  className="w-full mt-2 p-2 h-12 rounded bg-transparent border-white border-2 text-white"
                  required
                >
