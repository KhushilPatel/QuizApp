...
const Results = () => {
  ...
  return (
    <div className="container w-[1200px] mx-auto px-4 py-8">
      <h1 className="text-3xl font-bold text-center text-gray-800 mb-10">Admin Dashboard: Client Quiz Results</h1>
        ...
        <table className="min-w-full bg-white shadow-md rounded-lg">
          <thead className="bg-gray-100 border-b">
            <tr>
              ...
              <th className="text-left p-4 font-medium text-gray-700">Date of Birth</th>
              <th className="text-left p-4 font-medium text-gray-700">Gender</th>
              <th className="text-left p-4 font-medium text-gray-700">Status</th>
              <th className="text-left p-4 font-medium text-gray-700">Attempted Quizzes</th>
            </tr>
          </thead>
          <tbody>
            {filteredData.map(client => (
              <tr key={client.userId} className="border-b hover:bg-gray-50">
                ...
                <td className="p-4">
                  <span className={`px-2 py-1 rounded-full text-xs font-medium ${client.active ? 'bg-green-200 text-green-800' : 'bg-red-200 text-red-800'}`}>
